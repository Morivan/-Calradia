    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
      ...
      <div className="hero">
        <div className="hero-content" style={{ flex: 1 }}>
          ...
          <p style={{ margin: '14px 0 0', color: '#ddd8cc', fontSize: 15, lineHeight: 1.75, maxWidth: 480 }}>
            Беремся за заказы любой сложности и выполняем их в адекватные сроки.
            В команде — мастера разных профилей. При заказе комплектами действуют скидки.
            Также занимаемся ремонтом, модификацией и проверкой снаряжения по правилам мероприятий.
            Готовы к уникальным проектам.
          </p>
